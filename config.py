...
class ISCXVPNConfig(Config):
    ...
    DIR_PATH_DICT = {0: r'D:/data/splitVPN1/tcp/cate/Chat',
                     1: r'D:/data/splitVPN1/tcp/cate/Email',
                     2: r'D:/data/splitVPN1/tcp/cate/File',
                     3: r'D:/data/splitVPN1/tcp/cate/P2P',
                     4: r'D:/data/splitVPN1/tcp/cate/Streaming',
                     5: r'D:/data/splitVPN1/tcp/cate/VoIP',
                     }
...
class ISCXTorConfig(Config):
    TRAIN_DATA = r'D:/data/pcap2graph/npz/train.npz'
    HEADER_TRAIN_DATA = r'D:/data/pcap2graph/npz/header_train.npz'
    TEST_DATA = r'D:/data/pcap2graph/npz/test.npz'
    HEADER_TEST_DATA = r'D:/data/pcap2graph/npz/header_test.npz'

    TRAIN_GRAPH_DATA = r'D:/data/pcap2graph/dgl/train_graph.dgl'
    HEADER_TRAIN_GRAPH_DATA = r'D:/data/pcap2graph/dgl/header_train_graph.dgl'
    TEST_GRAPH_DATA = r'D:/data/pcap2graph/dgl/test_graph.dgl'
    HEADER_TEST_GRAPH_DATA = r'D:/data/pcap2graph/dgl/header_test_graph.dgl'
    ...
    DIR_PATH_DICT = {0: r'D:/data/pcap2graph/cate/Audio-Streaming',
                     1: r'D:/data/pcap2graph/cate/Browsing',
                     2: r'D:/data/pcap2graph/cate/Chat',
                     3: r'D:/data/pcap2graph/cate/File',
                     4: r'D:/data/pcap2graph/cate/Mail',
                     5: r'D:/data/pcap2graph/cate/P2P',
                     6: r'D:/data/pcap2graph/cate/Video-Streaming',
                     7: r'D:/data/pcap2graph/cate/VoIP'
                     }
